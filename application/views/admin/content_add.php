		    ...
		    <div class="form-group">
				...
				<div class="col-xs-12 col-sm-9">
					<div class="input-group col-xs-12 col-sm-8">
					    <input type="text" name="content_title" id="content_title" value="<?php echo set_value('content_title'); ?>" class="form-control limited" maxlength="20" placeholder="Content title"/>
